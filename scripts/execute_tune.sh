...
function execute_lookups_200M() {
    ...
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_1.000000i_0m --through --pareto --search $2 --only $3 --csv
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_1.000000i_1m --through --pareto --search $2 --only $3 --csv
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_1.000000i_2m_0.006000h --through --pareto --search $2 --only $3 --csv
}
...
function execute_lookups_200M_multithread() {
    ...
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_1.000000i_0m_24t --through --pareto --search $2 --only $3 --csv --threads 24
}
...
function execute_string_90M() {
    ...
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_1.000000i_0m_9Mbulkload --through --pareto --search $2 --only $3 --csv
}

function execute_string_90M_multithread() {
    echo "Executing lookups for dataset $1, index $3, and search method $2"
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_0.000000i_24t_10Mbulkload1 --through --pareto --search $2 --only $3 --csv --threads 24
    $BENCHMARK ./data/$1 ./data/$1_ops_1M_0.000000rq_0.000000nl_1.000000i_0m_24t_9Mbulkload --through --pareto --search $2 --only $3 --csv --threads 24
}
