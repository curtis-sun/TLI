...
function generate_uint64_200M() {
    ...
    # ./generate ../data/$1 10000000 --negative-lookup-ratio 0.5 --bulkload-count 10000000
    ./generate ../data/$1 360000000 --insert-ratio 0.5 --negative-lookup-ratio 0.5 --block 9
...
generate_string_90M url_90M_string
