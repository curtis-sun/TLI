...
for DATA_SET in $DATA_SETS; do
  ./build/bench_end_to_end ../SOSD/data/${DATA_SET} ../${DATA_SET}_equality_lookups_10M rs
  ./build/bench_end_to_end ../SOSD/data/${DATA_SET} ../${DATA_SET}_equality_lookups_10M ts
done;